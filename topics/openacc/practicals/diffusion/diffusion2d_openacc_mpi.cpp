...
int main(int argc, char** argv) {
...
#endif
    {
        ...
        for(auto step=0; step<nsteps; ++step) {
...
#ifdef OPENACC_DATA
            // TODO: Use device pointers if RDMA is enabled for the MPI
            //       communication. Otherwise update the host copies before
            //       communicating
#endif
            {
                if (south >= 0) {
            ...
            // TODO: If not in RDMA mode, update the device copies after
            //       communicating
